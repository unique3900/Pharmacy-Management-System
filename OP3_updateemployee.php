<?php
        ...
        ///To give hint what user is updating....Purano data dekhauna ko lagi
                ...
                <form method="POST">
                    <div class="user-details">
                        ...
                        <div class="input-box">
                            ...
                            <input type="email" id="add_email" name="email" value="<?php echo $email;  ?>" onkeyup="validateEmail()" required>
                            <span id="emailErr"  style="color:red"></span>
                        </div>
                        <div class="input-box">
                            <span class="details">Phone</span>
                            <input type="tel" id="add_phone" name="phone" value="<?php echo $phone;  ?>" onkeyup="validatePhone()" required minlength="10">
                            <span id="phoneErr"  style="color:red"></span>
                        </div>
                        <div class="input-box">
                            <span class="details">Permanent Address</span>
                            <input type="text" name="permanent_address" value="<?php echo $permanentaddress;  ?>" onkeyup="validateAddress()" id="add_address" required>
                            <span id="addressErr"  style="color:red"></span>
                        </div>
                        <div class="input-box">
                            <span class="details">Temporary Address</span>
                            <input type="text" name="temporary_address" value="<?php echo $temporaryaddress;  ?>" onkeyup="validateAddress()" id="add_address">
                            <span id="addressErr"  style="color:red"></span>
                        </div>
                        <div class="input-box">
                            <span class="details">Date of Birth</span>
                            <input type="date" name="dob" value="<?php echo $Date_of_birth;  ?>" id="add_dateofbirth" required>
                            <span id="addressErr"  style="color:red"></span>
                        </div>
                    ...
                    <div class="button">
                        ...
                        <button type="submit" id="add_user_btn" name="update" value="Add User" onclick="validateform()">Update</button>
