...
<body>
    <div class="container">
        ...
        <section class="main" id="main">
          <div class="side_btn">
                          <img src="icons/menu.svg" class="side_btn" id="opensidemenu" onclick="opensidemenu()" alt="">
                      </div>
            ...
            <a href="OP7_addmedicine.php"><button id="Add_btn">Add Medicine</button></a>
            <a href="OP10_addcategory.php"><button id="Add_btn">Add Category</button></a>
            <a href="OP12_todayssale.php"><button id="Add_btn">Today's Sale</button></a>
                ...
                <table class="t_table" id="crud_table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td data-label="Operations"><a href="OP8_updateinventory.php?updateid=' . $id . '"><button id="up_btn">Update</button></a>
                             <a href="OP9_deleteinventory.php?deleteid=' . $id . '"><button id="del_btn">Delete</button></a></td>
                        </tr>';
                            $count1++;
                        }
                        ?>
